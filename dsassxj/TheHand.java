...
class TheHand<T extends Comparable<T>, N extends Number & Comparable<N>> {
    ...
    public void findMaximumSpanningTree() {
        ...
        //System.out.println(directed.getAllEdges2());
        ...
        //System.out.println(mst.getAllEdges2());

        for (Edge<T, N> directedEdge : directedEdges) {
            for (Edge<T, N> mstEdge : mstEdges) {
                if (directed.hasEdge(mstEdge.fromVertex.vertexInfo, mstEdge.toVertex.vertexInfo) || directed.hasEdge(mstEdge.toVertex.vertexInfo, mstEdge.fromVertex.vertexInfo)){
