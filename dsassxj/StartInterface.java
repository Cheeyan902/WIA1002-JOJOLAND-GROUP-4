...
public class StartInterface {
    ...
    public static void saveGame(){
        ...
        ArrayList<ArrayList<orderList>> o = residentOrderLists;
    ...
    public static void loadGame() throws FileNotFoundException, ParseException, IOException{
        ...
        JSONObject json  = (JSONObject) new JSONParser().parse(new FileReader("savedGame.json"));
        ...
        if(json.containsKey("residentOrderLists")){
