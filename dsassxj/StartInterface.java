...
public class StartInterface {
    ...
    //method for Heavan Door
    public static void HeavansDoor(){
        String residentFilePath = "resident.csv";
        String standFilePath = "stand.csv";

        loadFile loadSystemFile = new loadFile();
        ArrayList<resident> resident = loadSystemFile.loadresidentFromFile("residents.csv");
        ArrayList<stand> stand = loadSystemFile.loadstandFromFile("stands.csv");
